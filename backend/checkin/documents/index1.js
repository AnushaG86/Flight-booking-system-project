...
<div class="box">
  ...
  <div class="ticket">
    <span class="airline">AIRLINES</span>
    <span class="airline airlineslip">AIRLINES</span>
    <span class="boarding">Boarding pass</span>
    <div class="content">
      <span class="jfk">${booking.dept_from}</span>
      ...
      <span class="sfo">${booking.dept_to}</span>
      
      <span class="jfk jfkslip">${booking.dept_from}</span>
      ...
      <span class="sfo sfoslip">${booking.dept_to}</span>
      <div class="sub-content">
        <span class="watermark">AIRLINES</span>
        <span class="name">PASSENGER NAME<br><span>ALEX PARRISH</span></span>
        <span class="flight">FLIGHT N&deg;<br><span>AIRLINES</span></span>
        <span class="seat">SEAT<br><span>45A</span></span>
        <span class="boardingtime">BOARDING ON<br><span>${booking.date}</span></span>
            
         <span class="flight flightslip">FLIGHT N&deg;<br><span>AIRLINES</span></span>
          <span class="seat seatslip">SEAT<br><span>45A</span></span>
         <span class="name nameslip">PASSENGER NAME<br><span>
           ALEX PARRISH</span></span>
      </div>
    </div>
